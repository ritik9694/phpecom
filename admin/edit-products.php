                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="checkbox"<?= $data['status']== '0'?'':'checked' ?> >
                                        </div>
                                        <div class="col-md-3">
                                            <label class="mb-0">Trending</label> <br>
                                            <input type="checkbox" <?= $data['trending']== '0'?'':'checked' ?> >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea type="text" required name="meta_description"  placeholder="Enter Meta Description" class="form-control mb-2"><?= $data['meta_description']; ?></textarea>
                                    </div>

                                    <div class="col-md-12">
                                        <label class="mb-0">Meta Keyword</label>
                                        <input type="text" required name="meta_keywords" value="<?= $data['slug']; ?>" placeholder="Enter Meta Keyword" class="form-control mb-2">
                                    </div>
