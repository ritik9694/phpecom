                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" required name="original_price" placeholder="Original Price" class="form-control mb-2">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea type="text" required name="meta_description" placeholder="Enter Meta Description" class="form-control mb-2"></textarea>
                            </div>

                            <div class="col-md-12">
                                <label class="mb-0">Meta Keyword</label>
                                <input type="text" required name="meta_keywords" placeholder="Enter Meta Keyword" class="form-control mb-2">
                            </div>
